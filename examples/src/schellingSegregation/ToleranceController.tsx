...
export type ToleranceControllerHandle = {
...
export const ToleranceController = React.memo(
  forwardRef<ToleranceControllerHandle, ToleranceControllerProps>(
    (props, ref) => {
      const {
        tolerance,
        grid,
        ...
        <>
          ...
          >
            <Typography fontSize={11}>
              moves: {movingAgentCount.toLocaleString()}
            </Typography>
